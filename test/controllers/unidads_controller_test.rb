...
class UnidadsControllerTest < ActionController::TestCase
  ...
  test "should create unidad" do
    assert_difference('Unidad.count') do
      post :create, unidad: { año: @unidad.año, fueraDeServicio: @unidad.fueraDeServicio, marca: @unidad.marca, patente: @unidad.patente, taller_id: @unidad.taller_id }
    end
  ...
  test "should update unidad" do
    patch :update, id: @unidad, unidad: { año: @unidad.año, fueraDeServicio: @unidad.fueraDeServicio, marca: @unidad.marca, patente: @unidad.patente, taller_id: @unidad.taller_id }
    assert_redirected_to unidad_path(assigns(:unidad))
  end
